...
pub async fn get_meta_information(
    ...
    SwapsHistoryMeta {
        ...
        to_asset_count: end_record.to_asset_count - start_record.to_asset_count,
        to_rune_count: end_record.to_rune_count - start_record.to_rune_count,
        to_trade_count: end_record.to_trade_count - start_record.to_trade_count,
        from_trade_count: end_record.from_trade_count - start_record.from_trade_count,
        synth_mint_count: end_record.synth_mint_count - start_record.synth_mint_count,
        synth_redeem_count: end_record.synth_redeem_count - start_record.synth_redeem_count,
        total_count: end_record.total_count - start_record.total_count,
        to_asset_volume: end_record.to_asset_volume - start_record.to_asset_volume,
        to_rune_volume: end_record.to_rune_volume - start_record.to_rune_volume,
        to_trade_volume: end_record.to_trade_volume - start_record.to_trade_volume,
        from_trade_volume: end_record.from_trade_volume - start_record.from_trade_volume,
        synth_mint_volume: end_record.synth_mint_volume - start_record.synth_mint_volume,
        synth_redeem_volume: end_record.synth_redeem_volume - start_record.synth_redeem_volume,
        total_volume: end_record.total_volume - start_record.total_volume,
        to_asset_volume_usd: end_record.to_asset_volume_usd - start_record.to_asset_volume_usd,
        to_rune_volume_usd: end_record.to_rune_volume_usd - start_record.to_rune_volume_usd,
        to_trade_volume_usd: end_record.to_trade_volume_usd - start_record.to_trade_volume_usd,
        from_trade_volume_usd: end_record.from_trade_volume_usd
            - start_record.from_trade_volume_usd,
        synth_mint_volume_usd: end_record.synth_mint_volume_usd
            - start_record.synth_mint_volume_usd,
        synth_redeem_volume_usd: end_record.synth_redeem_volume_usd
            - start_record.synth_redeem_volume_usd,
        total_volume_usd: end_record.total_volume_usd - start_record.total_volume_usd,
        to_asset_fees: end_record.to_asset_fees - start_record.to_asset_fees,
        to_rune_fees: end_record.to_rune_fees - start_record.to_rune_fees,
        to_trade_fees: end_record.to_trade_fees - start_record.to_trade_fees,
        from_trade_fees: end_record.from_trade_fees - start_record.from_trade_fees,
        synth_mint_fees: end_record.synth_mint_fees - start_record.synth_mint_fees,
        synth_redeem_fees: end_record.synth_redeem_fees - start_record.synth_redeem_fees,
        total_fees: end_record.total_fees - start_record.total_fees,
        to_asset_average_slip: end_record.to_asset_average_slip
            - start_record.to_asset_average_slip,
        to_rune_average_slip: end_record.to_rune_average_slip - start_record.to_rune_average_slip,
        to_trade_average_slip: end_record.to_trade_average_slip
            - start_record.to_trade_average_slip,
        from_trade_average_slip: end_record.from_trade_average_slip
            - start_record.from_trade_average_slip,
        synth_mint_average_slip: end_record.synth_mint_average_slip
            - start_record.synth_mint_average_slip,
        synth_redeem_average_slip: end_record.synth_redeem_average_slip
            - start_record.synth_redeem_average_slip,
        average_slip: end_record.average_slip - start_record.average_slip,
        rune_price_usd: end_record.rune_price_usd - start_record.rune_price_usd,
    }
}
